...
def _joints_position_rad(span):
    ...
    tip_angle = clamp(tip_angle / 180 * math.pi) + 0.5
    base_angle = clamp(base_angle / 180 * math.pi) - 0.5
...
grip_joints = ["edo_gripper_left_base_joint", "edo_gripper_right_base_joint", "edo_gripper_left_finger_joint",
               "edo_gripper_right_finger_joint"]

if __name__ == "__main__":
    print(transform_joint_7_to_grip_states(1))
    print(transform_joint_7_to_grip_states(0))
